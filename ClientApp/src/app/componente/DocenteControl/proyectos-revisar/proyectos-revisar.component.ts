...
@Component({
  selector: 'app-proyectos-revisar',
  templateUrl: './proyectos-revisar.component.html',
  styleUrls: ['./proyectos-revisar.component.css']
})
export class ProyectosRevisarComponent implements OnInit {
  searchText: string;
  proyectos: Proyecto[];
